    ...
    <div className={"container-fluid"}>
        ...
        <table className="table">
            ...
            <tr className={"row col-12 mx-auto"}>
                ...
                <th scope="col" className={"col-md-2"}>Username</th>
                <th scope="col" className={"col-md-2"}>Email</th>
                <th scope="col" className={"col-md-2"}>First Name</th>
                <th scope="col" className={"col-md-2"}>Last Name</th>
